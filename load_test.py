...
with concurrent.futures.ThreadPoolExecutor(max_workers=CONCURRENT_REQUESTS) as executor:
    ...
    future_to_request = {
        executor.submit(invoke_lambda, i): i for i in range(CONCURRENT_REQUESTS)
    }
...
print(
    f"{CONCURRENT_REQUESTS} Requests has {succ_cases} successful cases and {fail_cases} cases, success rate {succ_cases/CONCURRENT_REQUESTS}"
)
